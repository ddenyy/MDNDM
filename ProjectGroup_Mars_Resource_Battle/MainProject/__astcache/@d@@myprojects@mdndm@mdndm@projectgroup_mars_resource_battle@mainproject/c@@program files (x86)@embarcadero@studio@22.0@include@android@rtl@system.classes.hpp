...
// (DO NOT EDIT: machine generated header) 'System.Classes.pas' rev: 35.00 (Android)
...
#else /* __aarch64__ */
	long __fastcall GetByteCount(const System::TArray__1<System::Byte> Buffer, long Offset, long Count);
#endif /* __aarch64__ */
...
#else /* __aarch64__ */
	inline long __fastcall  Read(System::TArray__1<System::Byte> Buffer, long Offset, long Count){ return TStream::Read(Buffer, Offset, Count); }
	inline long __fastcall  Read(System::TArray__1<System::Byte> &Buffer, long Count){ return TStream::Read(Buffer, Count); }
	inline long __fastcall  Write(const System::TArray__1<System::Byte> Buffer, long Offset, long Count){ return TStream::Write(Buffer, Offset, Count); }
...
private:
	...
	{
		virtual void __fastcall Invoke(NativeUInt AThreadID, bool &AQueueEvent, bool &AForceQueue, TThreadMethod &AMethod, _di_TThreadProcedure &AProcedure) = 0 ;
	};
...
public:
	...
	static constexpr System::Int8 IteratorLinkID = System::Int8(0x5);
...
static constexpr System::Int8 pidAndroidArm32 = System::Int8(0x10);
static constexpr System::Int8 pidAndroid32Arm _DEPRECATED_ATTRIBUTE1("Use pidAndroidArm32")  = System::Int8(0x10);
static constexpr System::Int8 pidAndroid _DEPRECATED_ATTRIBUTE1("Use pidAndroidArm32")  = System::Int8(0x10);
...
static constexpr System::Word pidWin32ARM _DEPRECATED_ATTRIBUTE1("Use pidWinARM32")  = System::Word(0x800);
static constexpr System::Word pidOSX64 = System::Word(0x1000);
static constexpr System::Word pidLinuxArm32 = System::Word(0x2000);
static constexpr System::Word pidLinuxArm64 = System::Word(0x4000);
static constexpr System::Word pidAndroidArm64 = System::Word(0x8000);
static constexpr System::Word pidAndroid64Arm _DEPRECATED_ATTRIBUTE1("Use pidAndroidArm64")  = System::Word(0x8000);
static constexpr int pidiOSSimulator64 = int(0x10000);
static constexpr int pidOSXArm64 = int(0x20000);
static constexpr int pidWinArm64 = int(0x40000);
static constexpr int pidiOSSimulatorArm64 = int(0x80000);
static constexpr int pidAllPlatforms = int(0x394df);
static constexpr System::Int8 pfidWindows = System::Int8(0x3);
static constexpr int pfidOSX = int(0x21004);
