...
// (DO NOT EDIT: machine generated header) 'Androidapi.JNI.Os.pas' rev: 35.00 (Android)
...
__interface DELPHIINTERFACE JEnvironmentClass;
typedef System::DelphiInterface<JEnvironmentClass> _di_JEnvironmentClass;
__interface DELPHIINTERFACE JEnvironment;
typedef System::DelphiInterface<JEnvironment> _di_JEnvironment;
class DELPHICLASS TJEnvironment;
...
__interface  INTERFACE_UUID("{847171A2-7B65-4251-9BD3-E0BC89DE31FD}") JEnvironmentClass  : public Androidapi::Jni::Javatypes::JObjectClass 
{
	virtual Androidapi::Jni::Javatypes::_di_JString __cdecl _GetDIRECTORY_ALARMS() = 0 ;
	virtual void __cdecl _SetDIRECTORY_ALARMS(Androidapi::Jni::Javatypes::_di_JString Value) = 0 ;
	virtual Androidapi::Jni::Javatypes::_di_JString __cdecl _GetDIRECTORY_DCIM() = 0 ;
	virtual void __cdecl _SetDIRECTORY_DCIM(Androidapi::Jni::Javatypes::_di_JString Value) = 0 ;
	virtual Androidapi::Jni::Javatypes::_di_JString __cdecl _GetDIRECTORY_DOCUMENTS() = 0 ;
	virtual void __cdecl _SetDIRECTORY_DOCUMENTS(Androidapi::Jni::Javatypes::_di_JString Value) = 0 ;
	virtual Androidapi::Jni::Javatypes::_di_JString __cdecl _GetDIRECTORY_DOWNLOADS() = 0 ;
	virtual void __cdecl _SetDIRECTORY_DOWNLOADS(Androidapi::Jni::Javatypes::_di_JString Value) = 0 ;
	virtual Androidapi::Jni::Javatypes::_di_JString __cdecl _GetDIRECTORY_MOVIES() = 0 ;
	virtual void __cdecl _SetDIRECTORY_MOVIES(Androidapi::Jni::Javatypes::_di_JString Value) = 0 ;
	virtual Androidapi::Jni::Javatypes::_di_JString __cdecl _GetDIRECTORY_MUSIC() = 0 ;
	virtual void __cdecl _SetDIRECTORY_MUSIC(Androidapi::Jni::Javatypes::_di_JString Value) = 0 ;
	virtual Androidapi::Jni::Javatypes::_di_JString __cdecl _GetDIRECTORY_NOTIFICATIONS() = 0 ;
	virtual void __cdecl _SetDIRECTORY_NOTIFICATIONS(Androidapi::Jni::Javatypes::_di_JString Value) = 0 ;
	virtual Androidapi::Jni::Javatypes::_di_JString __cdecl _GetDIRECTORY_PICTURES() = 0 ;
	virtual void __cdecl _SetDIRECTORY_PICTURES(Androidapi::Jni::Javatypes::_di_JString Value) = 0 ;
	virtual Androidapi::Jni::Javatypes::_di_JString __cdecl _GetDIRECTORY_PODCASTS() = 0 ;
	virtual void __cdecl _SetDIRECTORY_PODCASTS(Androidapi::Jni::Javatypes::_di_JString Value) = 0 ;
	virtual Androidapi::Jni::Javatypes::_di_JString __cdecl _GetDIRECTORY_RINGTONES() = 0 ;
	virtual void __cdecl _SetDIRECTORY_RINGTONES(Androidapi::Jni::Javatypes::_di_JString Value) = 0 ;
	virtual Androidapi::Jni::Javatypes::_di_JString __cdecl _GetMEDIA_BAD_REMOVAL() = 0 ;
	virtual Androidapi::Jni::Javatypes::_di_JString __cdecl _GetMEDIA_CHECKING() = 0 ;
	virtual Androidapi::Jni::Javatypes::_di_JString __cdecl _GetMEDIA_EJECTING() = 0 ;
	virtual Androidapi::Jni::Javatypes::_di_JString __cdecl _GetMEDIA_MOUNTED() = 0 ;
	virtual Androidapi::Jni::Javatypes::_di_JString __cdecl _GetMEDIA_MOUNTED_READ_ONLY() = 0 ;
	virtual Androidapi::Jni::Javatypes::_di_JString __cdecl _GetMEDIA_NOFS() = 0 ;
	virtual Androidapi::Jni::Javatypes::_di_JString __cdecl _GetMEDIA_REMOVED() = 0 ;
	virtual Androidapi::Jni::Javatypes::_di_JString __cdecl _GetMEDIA_SHARED() = 0 ;
	virtual Androidapi::Jni::Javatypes::_di_JString __cdecl _GetMEDIA_UNKNOWN() = 0 ;
	virtual Androidapi::Jni::Javatypes::_di_JString __cdecl _GetMEDIA_UNMOUNTABLE() = 0 ;
	virtual Androidapi::Jni::Javatypes::_di_JString __cdecl _GetMEDIA_UNMOUNTED() = 0 ;
	HIDESBASE virtual _di_JEnvironment __cdecl init() = 0 ;
	virtual Androidapi::Jni::Javatypes::_di_JFile __cdecl getDataDirectory() = 0 ;
	virtual Androidapi::Jni::Javatypes::_di_JFile __cdecl getDownloadCacheDirectory() = 0 ;
	virtual Androidapi::Jni::Javatypes::_di_JFile __cdecl getExternalStorageDirectory() = 0 ;
	virtual Androidapi::Jni::Javatypes::_di_JFile __cdecl getExternalStoragePublicDirectory(Androidapi::Jni::Javatypes::_di_JString type_) = 0 ;
	virtual Androidapi::Jni::Javatypes::_di_JString __cdecl getExternalStorageState() = 0 /* overload */;
	virtual Androidapi::Jni::Javatypes::_di_JString __cdecl getExternalStorageState(Androidapi::Jni::Javatypes::_di_JFile path) = 0 /* overload */;
	virtual Androidapi::Jni::Javatypes::_di_JFile __cdecl getRootDirectory() = 0 ;
	virtual Androidapi::Jni::Javatypes::_di_JString __cdecl getStorageState(Androidapi::Jni::Javatypes::_di_JFile path) = 0 ;
	virtual bool __cdecl isExternalStorageEmulated() = 0 /* overload */;
	virtual bool __cdecl isExternalStorageEmulated(Androidapi::Jni::Javatypes::_di_JFile path) = 0 /* overload */;
	virtual bool __cdecl isExternalStorageRemovable() = 0 /* overload */;
	virtual bool __cdecl isExternalStorageRemovable(Androidapi::Jni::Javatypes::_di_JFile path) = 0 /* overload */;
	__property Androidapi::Jni::Javatypes::_di_JString DIRECTORY_ALARMS = {read=_GetDIRECTORY_ALARMS, write=_SetDIRECTORY_ALARMS};
	__property Androidapi::Jni::Javatypes::_di_JString DIRECTORY_DCIM = {read=_GetDIRECTORY_DCIM, write=_SetDIRECTORY_DCIM};
	__property Androidapi::Jni::Javatypes::_di_JString DIRECTORY_DOCUMENTS = {read=_GetDIRECTORY_DOCUMENTS, write=_SetDIRECTORY_DOCUMENTS};
	__property Androidapi::Jni::Javatypes::_di_JString DIRECTORY_DOWNLOADS = {read=_GetDIRECTORY_DOWNLOADS, write=_SetDIRECTORY_DOWNLOADS};
	__property Androidapi::Jni::Javatypes::_di_JString DIRECTORY_MOVIES = {read=_GetDIRECTORY_MOVIES, write=_SetDIRECTORY_MOVIES};
	__property Androidapi::Jni::Javatypes::_di_JString DIRECTORY_MUSIC = {read=_GetDIRECTORY_MUSIC, write=_SetDIRECTORY_MUSIC};
	__property Androidapi::Jni::Javatypes::_di_JString DIRECTORY_NOTIFICATIONS = {read=_GetDIRECTORY_NOTIFICATIONS, write=_SetDIRECTORY_NOTIFICATIONS};
	__property Androidapi::Jni::Javatypes::_di_JString DIRECTORY_PICTURES = {read=_GetDIRECTORY_PICTURES, write=_SetDIRECTORY_PICTURES};
	__property Androidapi::Jni::Javatypes::_di_JString DIRECTORY_PODCASTS = {read=_GetDIRECTORY_PODCASTS, write=_SetDIRECTORY_PODCASTS};
	__property Androidapi::Jni::Javatypes::_di_JString DIRECTORY_RINGTONES = {read=_GetDIRECTORY_RINGTONES, write=_SetDIRECTORY_RINGTONES};
	__property Androidapi::Jni::Javatypes::_di_JString MEDIA_BAD_REMOVAL = {read=_GetMEDIA_BAD_REMOVAL};
	__property Androidapi::Jni::Javatypes::_di_JString MEDIA_CHECKING = {read=_GetMEDIA_CHECKING};
	__property Androidapi::Jni::Javatypes::_di_JString MEDIA_EJECTING = {read=_GetMEDIA_EJECTING};
	__property Androidapi::Jni::Javatypes::_di_JString MEDIA_MOUNTED = {read=_GetMEDIA_MOUNTED};
	__property Androidapi::Jni::Javatypes::_di_JString MEDIA_MOUNTED_READ_ONLY = {read=_GetMEDIA_MOUNTED_READ_ONLY};
	__property Androidapi::Jni::Javatypes::_di_JString MEDIA_NOFS = {read=_GetMEDIA_NOFS};
	__property Androidapi::Jni::Javatypes::_di_JString MEDIA_REMOVED = {read=_GetMEDIA_REMOVED};
	__property Androidapi::Jni::Javatypes::_di_JString MEDIA_SHARED = {read=_GetMEDIA_SHARED};
	__property Androidapi::Jni::Javatypes::_di_JString MEDIA_UNKNOWN = {read=_GetMEDIA_UNKNOWN};
	__property Androidapi::Jni::Javatypes::_di_JString MEDIA_UNMOUNTABLE = {read=_GetMEDIA_UNMOUNTABLE};
	__property Androidapi::Jni::Javatypes::_di_JString MEDIA_UNMOUNTED = {read=_GetMEDIA_UNMOUNTED};
};

__interface  INTERFACE_UUID("{8A8591BC-BC01-4338-91D8-2671DAB231F8}") JEnvironment  : public Androidapi::Jni::Javatypes::JObject 
{
...
#pragma pack(push,4)
#endif /* not __aarch64__ */
class PASCALIMPLEMENTATION TJEnvironment : public Androidapi::Jnibridge::TJavaGenericImport__2<_di_JEnvironmentClass,_di_JEnvironment>
{
	typedef Androidapi::Jnibridge::TJavaGenericImport__2<_di_JEnvironmentClass,_di_JEnvironment> inherited;
	
public:
	/* TObject.Create */ inline __fastcall TJEnvironment() : Androidapi::Jnibridge::TJavaGenericImport__2<_di_JEnvironmentClass,_di_JEnvironment>() { }
	/* TObject.Destroy */ inline __fastcall virtual ~TJEnvironment() { }
