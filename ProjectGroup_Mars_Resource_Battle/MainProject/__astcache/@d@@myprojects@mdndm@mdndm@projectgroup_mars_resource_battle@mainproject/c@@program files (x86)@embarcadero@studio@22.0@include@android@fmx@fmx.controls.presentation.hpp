...
// (DO NOT EDIT: machine generated header) 'FMX.Controls.Presentation.pas' rev: 35.00 (Android)
...
static constexpr System::Word PM_PAINT_CHILDREN = System::Word(0x43d);
static constexpr System::Word PM_GET_SCENE = System::Word(0x43e);
