...
// (DO NOT EDIT: machine generated header) 'Androidapi.JNIBridge.pas' rev: 35.00 (Android)
...
extern DELPHI_PACKAGE Androidapi::Jni::JNIObject __cdecl dispatchToNative2(Androidapi::Jni::PJNIEnv Env, Androidapi::Jni::JNIObject This, Androidapi::Jni::JNIObject MethodName, Androidapi::Jni::JNIObject MethodSig, Androidapi::Jni::JNIObject Args, __int64 DelphiObject);
